    ...
    <div className="app-sidebar">
      <div className="sidebar-content py-3 flex flex-column">
        ...
        <ul className="links my-4">
          <Link to='/home' className={`text-white flex align-center justify-center link-item ${ pathname === 'home' ? 'active-link' : "" }`}>
            <span className="flex align-center justify-center">
              <AiFillHome size={17}/>
            </span>
            <span className='icon-text'>Home</span>
          </Link>
          <Link to='/add' className={`text-white flex align-center justify-center link-item ${ pathname === 'add' ? 'active-link' : "" }`}>
            <span className="flex align-center justify-center">
              <BsPlusLg size={17}/>
            </span>
